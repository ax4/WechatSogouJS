...
var query_type = 'p',
    query_kw = 'thezoomin'
    query_start_date = "2017-06-27",
    query_end_date = "2017-07-11";
...
nightmare
  ...
  .evaluate(function(query_type, query_kw){
   ...
   .wait(500)
   .evaluate(function(query_start_date, query_end_date){
    //   .type("#date_start", query_date)
   // .type("#date_end", query_date)
      document.querySelector("#date_start").value = query_start_date;
      document.querySelector("#date_end").value = query_end_date;
