...
Nightmare.action('emulateDevice',
  ...
  var nightmare = Nightmare({ show: true });
    ...
    .evaluate(function () {
      ...
      for(var gzh in all_gzh){
        var obj = {name: get_gzh_name(gzh), id: get_gzh_id(gzh), month_num: get_gzh_month(gzh)};
        var text = gzh.querySelectorAll('dt');
        obj['intro'] = get_gzh_intro(gzh, text);
        obj['auth'] = get_gzh_auth(gzh, text);
        gzh_list.push(obj);
      }
